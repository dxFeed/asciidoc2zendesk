...
public class DynamicContentItem implements Serializable {
    ...
    public org.zendesk.client.v2.model.dynamic.DynamicContentItem id(Long id) {
        this.id = id;
        return this;
    }

    public org.zendesk.client.v2.model.dynamic.DynamicContentItem url(String url) {
        this.url = url;
        return this;
    }

    public org.zendesk.client.v2.model.dynamic.DynamicContentItem name(String name) {
        this.name = name;
        return this;
    }

    public org.zendesk.client.v2.model.dynamic.DynamicContentItem placeholder(String placeholder) {
        this.placeholder = placeholder;
        return this;
    }

    public org.zendesk.client.v2.model.dynamic.DynamicContentItem defaultLocaleId(Long defaultLocaleId) {
        this.defaultLocaleId = defaultLocaleId;
        return this;
    }

    public org.zendesk.client.v2.model.dynamic.DynamicContentItem outdated(Boolean outdated) {
        this.outdated = outdated;
        return this;
    }

    public org.zendesk.client.v2.model.dynamic.DynamicContentItem createdAt(Date createdAt) {
        this.createdAt = createdAt;
        return this;
    }

    public org.zendesk.client.v2.model.dynamic.DynamicContentItem updatedAt(Date updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }

    public org.zendesk.client.v2.model.dynamic.DynamicContentItem variants(List<DynamicContentItemVariant> variants) {
        this.variants = variants;
        return this;
    }
    ...
    public boolean equals(Object o) {
        if (o == this)
            return true;
        if (!(o instanceof org.zendesk.client.v2.model.dynamic.DynamicContentItem)) {
            return false;
        }
        org.zendesk.client.v2.model.dynamic.DynamicContentItem item = (org.zendesk.client.v2.model.dynamic.DynamicContentItem) o;
