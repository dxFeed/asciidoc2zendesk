...
import org.zendesk.client.v2.model.hc.UserType;
...
public class UserSegment implements SearchResultEntity {
    ...
    public org.zendesk.client.v2.model.hc.UserSegment setId(Long id) {
        this.id = id;
        return this;
    }
    ...
    public org.zendesk.client.v2.model.hc.UserSegment setName(String name) {
        this.name = name;
        return this;
    }
    ...
    public org.zendesk.client.v2.model.hc.UserSegment setUserType(UserType userType) {
    ...
    public org.zendesk.client.v2.model.hc.UserSegment setGroupIds(List<Long> groupIds) {
    ...
    public org.zendesk.client.v2.model.hc.UserSegment setOrganizationIds(List<Long> organizationIds) {
    ...
    public org.zendesk.client.v2.model.hc.UserSegment setTags(List<String> tags) {
        this.tags = tags;
        return this;
    }
    ...
    public org.zendesk.client.v2.model.hc.UserSegment setOrTags(List<String> orTags) {
        this.orTags = orTags;
        return this;
    }
    ...
    public org.zendesk.client.v2.model.hc.UserSegment setCreatedAt(Date createdAt) {
    ...
    public org.zendesk.client.v2.model.hc.UserSegment setUpdatedAt(Date updatedAt) {
    ...
    public org.zendesk.client.v2.model.hc.UserSegment setBuiltIn(Boolean builtIn) {
